        ...
        <div className="glass-dark p-12 md:p-20 rounded-[2.5rem] max-w-4xl space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up [animation-delay:400ms]">
            <Button
              asChild
              size="lg"
              className="bg-primary/40 backdrop-blur-xl hover:bg-primary/60 text-white border border-white/20 px-12 py-8 rounded-full text-base uppercase tracking-widest transition-all hover:scale-105"
            >
